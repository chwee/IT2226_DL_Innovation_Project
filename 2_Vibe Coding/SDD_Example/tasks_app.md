...
- **Related Documents**:
  - Requirements: `requirements_app.md` (v1.0)
  - Design: `design_app.md` (v1.0)
...
- [ ] **2. Implement TranslationRequest/Response data models and validation** *(Data Layer pattern)*
...
- [ ] **3. Create Translation Service business logic** *(Service Layer pattern)*
...
- [ ] **4. Implement Translate API endpoint** *(API Layer pattern)*
- [ ] **4.1 Add request validation to the POST /api/translate route**
...
- [ ] **4.2 Wire the route to the Translation Service and map responses**
...
- [ ] **4.3 Add backend logging per the design's logging strategy**
...
- [ ] **4.4 Write backend integration tests for the full endpoint**
...
- [ ] **5. Build the translator input form UI** *(UI Layer pattern)*
- [ ] **5.1 Create the input form components**
...
- [ ] **5.2 Implement client-side validation and request lifecycle state**
...
- [ ] **5.3 Implement the API client call to the backend**
...
- [ ] **6. Build result display and read-aloud UI** *(UI Layer pattern)*
- [ ] **6.1 Render translation results and error states**
...
- [ ] **6.2 Implement read-aloud via the Web Speech API**
  - **Scope**: Included — feature-detect `window.speechSynthesis`; show the read-aloud control only when available; speak `translatedText` via `SpeechSynthesisUtterance` on activation. Excluded — server-generated audio (explicitly ruled out in `design_app.md`).
  - **Acceptance Criteria**: In a browser supporting the API, activating the control produces audible speech of the translated text; in a browser without support, the control is hidden or disabled rather than present-but-broken
  ...
  - **_Requirements: 3.2, 3.3, 3.5; Usability NFR_**

- [ ] **6.3 Verify responsive/mobile usability**
...
- [ ] **7. Integrate frontend and backend, and validate against requirements** *(Integration pattern)*
- [ ] **7.1 Run the frontend against the live backend**
...
- [ ] **7.2 Execute end-to-end user scenarios**
...
- [ ] **7.3 Run the full automated test suite and confirm performance target**
...
- [ ] **7.4 Traceability check against requirements_app.md**
